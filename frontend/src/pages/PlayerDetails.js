        ...
        <div className="flex items-center space-x-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              {playerData.basic_info?.height} • {playerData.basic_info?.weight}{" "}
              lbs •{playerData.basic_info?.experience} years experience
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="card p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="text-center p-4 bg-blue-50 rounded-lg">
              ...
              <p className="text-2xl font-bold text-nba-blue">
                {playerData.current_season?.ppg || 0}
              </p>
            </div>
            <div className="text-center p-4 bg-green-50 rounded-lg">
              ...
              <p className="text-2xl font-bold text-green-600">
                {playerData.current_season?.rpg || 0}
              </p>
            </div>
            <div className="text-center p-4 bg-purple-50 rounded-lg">
              ...
              <p className="text-2xl font-bold text-purple-600">
                {playerData.current_season?.apg || 0}
              </p>
            </div>
            <div className="text-center p-4 bg-yellow-50 rounded-lg">
              ...
              <p className="text-2xl font-bold text-yellow-600">
                {playerData.current_season?.games || 0}
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            ...
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-xl font-bold text-gray-700">
                {((playerData.current_season?.three_pt_pct || 0) * 100).toFixed(
                  1
                )}
                %
              </p>
              ...
              <div className="mt-4 text-center">
                ...
                <span
                  className={`font-semibold ${
                    (predictions.next_game?.confidence || 0) >= 0.9
                      ? "text-green-600"
                      : (predictions.next_game?.confidence || 0) >= 0.8
                      ? "text-yellow-600"
                      : "text-red-600"
                  }`}
                >
